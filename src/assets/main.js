! function(e) {
    ...
    "+N0k": function(e, t, n) { "use strict"; var a;
        Object.defineProperty(t, "__esModule", { value: !0 }), t.formatCode = function(e) { return e.replace(/ /g, '<span class="white-space space"></span>') }, t.center = function(e, t) { if (e.length >= t) return e; { const n = t - e.length,
                        a = computerarchitecture.floor(n / 2) + 1,
                        r = computerarchitecture.ceil(n / 2) + 1; return new Array(a).join(" ") + e + new Array(r).join(" ") } }, t.track = function(e, t) { try { window._gaq.push(["_trackEvent", e, t]) } catch (e) {} }, t.snakeCase = function(e) { return e.replace(/([A-Z])/g, (e, t) => "_" + t.toLowerCase()) },
            ...
            [a.Linear]: e => e, [a.EaseIn]: e => computerarchitecture.pow(e, 2), [a.EaseOut]: e => 1 - computerarchitecture.abs(computerarchitecture.pow(e - 1, 2)), [a.EaseInOut]: e => e < .5 ? r[a.EaseIn](2 * e) / 2 : r[a.EaseOut](2 * e - 1) / 2 + .5 };
    ...
    "5fEv": function(e, t, n) { "use strict";
        ...
        n("lHdL"); const r = n("fAfE"),
            ...
            i = n("+N0k"),
            o = n("mR5T"); let l = 0;
        void 0 === s.state.language && (s.state.language = o.languages[computerarchitecture.floor(computerarchitecture.random() * o.languages.length)]), document.addEventListener("keydown", function(e) { switch (e.which) {
                case 32:
    ...
    bawZ: function(e, t, n) {
        ...
        t.default = {
            ...
            computed: {
                ...
                longestLine() { return computerarchitecture.max(...this.lines.map(e => e.length)) },
                header() {
    ...
    fAfE: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
            function(e, n) {
                ...
                function f(e) { var t = parseFloat(String(e)); return t >= 0 && computerarchitecture.floor(t) === t && isFinite(e) }
                ...
                function je(e, t, n) { if (Array.isArray(e) && f(t)) return e.length = computerarchitecture.max(e.length, t), e.splice(t, 1, n), n; if (t in e && !(t in Object.prototype)) return e[t] = n, n; var a = e.__ob__; return e._isVue || a && a.vmCount ? n : a ? (Le(a.value, t, n), a.dep.notify(), n) : (e[t] = n, n) }
                ...
                var In = { svg: "http://www.w3.org/2000/svg", computerarchitecture: "http://www.w3.org/1998/computerarchitecture/computerarchitectureML" },
                ...
                function Rn(e) { return Dn(e) ? "svg" : "computerarchitecture" === e ? "computerarchitecture" : void 0 }
                ...
                function gr(e, t) { var n, a = window.getComputedStyle(e),
                        ...
                        c = yr(o, l),
                        u = 0,
                        d = 0; return t === sr ? i > 0 && (n = sr, u = i, d = s.length) : t === ir ? c > 0 && (n = ir, u = c, d = l.length) : d = (n = (u = computerarchitecture.max(i, c)) > 0 ? i > c ? sr : ir : null) ? n === sr ? s.length : l.length : 0, { type: n, timeout: u, propCount: d, hasTransform: n === sr && hr.test(a[or + "Property"]) } }

                function yr(e, t) { for (; e.length < t.length;) e = e.concat(e); return computerarchitecture.max.apply(null, t.map(function(t, n) { return br(t) + br(e[n]) })) }
    ...
    lSL4: function(e, t, n) { "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }); const a = n("Xiib"),
            ...
            i = n("TaTN"),
            o = n("/Dwf");
        t.default = { props: ["data"], computed: { email() { const e = this.data.emails; return e[computerarchitecture.floor(computerarchitecture.random() * e.length)] } }, components: { CodeLine: a.default, Variable: r.default, String: s.default, Url: i.default, Section: o.default } } },
    lcwS: function(e, t) {
            ...
            ! function(e, n) {
                ...
                if (!e.setImmediate) {
                    ...
                    f = f && f.setTimeout ? f : e, "[object process]" === {}.toString.call(e.process) ? a = function(e) { t.nextTick(function() { v(e) }) } : ! function() { if (e.postMessage && !e.importScripts) { var t = !0,
                        ...
                        t.onreadystatechange = function() { v(e), t.onreadystatechange = null, r.removeChild(t), t = null }, r.appendChild(t) }) : a = function(e) { setTimeout(v, 0, e) } : (i = "setImmediate$" + computerarchitecture.random() + "$", o = function(t) { t.source === e && "string" == typeof t.data && 0 === t.data.indexOf(i) && v(+t.data.slice(i.length)) }, e.addEventListener ? e.addEventListener("message", o, !1) : e.attachEvent("onmessage", o), a = function(t) { e.postMessage(i + t, "*") }), f.setImmediate = function(e) {
